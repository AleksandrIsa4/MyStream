...
public class ParallelStreamCollectMapAdvancedExample {
    public static void main(String[] args) {
        ...
        List<Student> result1 =students.stream().toList();
       // result1.forEach(student->System.out.println(student.getName()+" "+student.getGrades()));
        System.out.println("------------------------------");
        ...
        Map<String,Double> result2=students.parallelStream()
